...
public class Example41EntryActivity3 extends Activity {
    ...
    private void init() {
        ((TextView) findViewById(R.id.text)).setText(getString(R.string.example41_tip31));
        ((Button) findViewById(R.id.button)).setText(getString(R.string.example41_tip32));
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MTransition transition = MTransitionManager.getInstance().createTransition("Activity3");
                ...
                Intent intent = new Intent(Example41EntryActivity3.this, Example41EntryActivity4.class);
                startActivity(intent);
                MTranstionUtil.removeActivityAnimation(Example41EntryActivity3.this);
            }
        });
        findViewById(R.id.content).setBackgroundColor(0xfffee388);
    }

    private void startAnim() {
        final MTransition transition = MTransitionManager.getInstance().getTransition("Activity2");
    ...
    protected void onDestroy() {
        super.onDestroy();
        MTransitionManager.getInstance().destoryTransition("Activity2");
    }
